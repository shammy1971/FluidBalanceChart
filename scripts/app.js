requirejs.config({
  paths: {
    ...
    //MODELS
    'fluidBalanceChart.model': 'models/fluidBalanceChart.model',
    'fluidBalanceChartEntry.model': 'models/fluidBalanceChartEntry.model',
    'fluidBalanceChartHour.model': 'models/fluidBalanceChartHour.model',
    'fluidBalanceChartReading.model': 'models/fluidBalanceChartReading.model',
    'fluidBalanceChartRoute.model': 'models/fluidBalanceChartRoute.model',

    //VIEWMODELS
    'fluidBalanceChart.viewmodel': 'viewModels/fluidBalanceChart.viewmodel',
  },
  shim: {
    'underscore': {
      exports: '_'
